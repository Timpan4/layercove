export default {
  ...
  nav: {
    ...
    installAppSuccess: 'LayerCove a été installé',
  },
  ...
  printers: {
    ...
    moonrakerExternalCameraUrl: 'URL de la caméra externe',
    moonrakerExternalCameraType: 'Type de caméra externe',
    ...
    maintenance: {
      ...
      editFieldHelp: "Quand activé, cette imprimante est mise en pause de MQTT, de la file d'attente et des notifications — utile pour les réparations, les installations LayerCove parallèles ou une suspension temporaire.",
    },
    // Chamber light
    ...
    dropNotPrintableGcode: 'Seuls les fichiers .gcode peuvent être imprimés sur cette imprimante',
    dropNotPrintable3mf: 'Seuls les fichiers .gcode.3mf peuvent être imprimés sur cette imprimante',
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'Le slicer n\'a pas laissé le fichier .gcode.3mf sur la carte SD de l\'imprimante, donc LayerCove n\'a pas pu récupérer la miniature ni les métadonnées slicer. C\'est généralement parce que « Stocker les fichiers envoyés sur stockage externe » est désactivé dans le slicer (onglet Périphérique de Bambu Studio / OrcaSlicer).',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'Les groupes LDAP sont associés aux groupes LayerCove à la connexion',
      ...
      autoProvisionHint: 'Créer automatiquement un compte LayerCove lors de la première connexion LDAP',
      ...
      groupMappingHint: 'Associer les DN de groupes LDAP aux groupes LayerCove. Groupes disponibles : ',
    ...
    preheatFilamentTargetsHint: 'LayerCove choisit la cible la plus haute parmi les slots AMS chargés ; les impressions PLA uniquement dérivent 0 et sautent la phase chambre automatiquement.',
    ...
    // Additional settings
    configureBambuddy: 'Configurer LayerCove',
    ...
    bambuddySoftware: 'Logiciel LayerCove',
    ...
    updateViaHomeAssistant: 'Les mises à jour sont gérées par le superviseur Home Assistant. Ouvrez Paramètres → Modules complémentaires → LayerCove dans Home Assistant pour installer la nouvelle version.',
    ...
    externalUrlDescription: 'L\'URL externe où LayerCove est accessible. Utilisée pour les images de notification et les intégrations externes.',
    ...
    mqttDescription: 'Publier les événements LayerCove vers un broker MQTT externe pour l\'intégration avec Node-RED, Home Assistant et d\'autres systèmes d\'automatisation.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'Les secrets TOTP et client_secrets OIDC sont stockés en clair. Définissez MFA_ENCRYPTION_KEY ou redémarrez LayerCove avec un répertoire de données accessible en écriture pour en générer un automatiquement.',
      ...
      migrationErrorWarning: "{{count}} ligne(s) ancienne(s) n'ont pas pu être rechiffrée(s) au démarrage. Vérifiez les journaux du serveur et redémarrez LayerCove pour réessayer.",
    },
  ...
  login: {
    ...
    resetStep1: 'Contactez votre admin LayerCove',
    ...
    twoFA: {
      ...
      instructionsTotp: "Ouvrez votre application d'authentification et saisissez le code à 6 chiffres pour LayerCove.",
  ...
  users: {
    ...
    subtitle: 'Gérez les accès à LayerCove',
    backToSettings: 'Retour aux paramètres',
    createUser: 'Créer un utilisateur',
    noPermission: 'Accès refusé.',
    admin: 'Administrateur',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Connectez-vous à votre compte Orca Cloud pour synchroniser vos profils de slicer dans LayerCove.',
      },
      providers: {
  ...
  sponsors: {
    ...
    tagline: 'LayerCove est gratuit et le reste parce que des personnes choisissent de le soutenir. Pas de VC, pas de verrouillage cloud.',
    viewSupporters: 'Voir les soutiens',
    toastPrints: 'Tu as terminé {{count}} impressions avec LayerCove. LayerCove reste gratuit grâce à ceux qui le soutiennent.',
    toastCost: 'Tu as suivi {{total}} de filament avec LayerCove. Vois qui garde le projet indépendant.',
    toastArchives: '{{count}} impressions archivées avec LayerCove. Vois qui le garde indépendant.',
    toastAnniversary: 'Un an avec LayerCove ! Vois qui garde le projet indépendant.',
    toastVersionUpdate: 'Mis à jour vers v{{version}}. LayerCove reste gratuit grâce à ceux qui le soutiennent.',
  },
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'LayerCove est servi en HTTPS (via votre reverse proxy), mais votre URL Spoolman est encore en HTTP. Les navigateurs bloquent le contenu mixte pour des raisons de sécurité, donc l\'interface Spoolman intégrée ne peut pas s\'afficher. Spoolman doit être accessible en HTTPS.',
    spoolmanMixedContentFixReverseProxy: 'Placez Spoolman derrière le même reverse proxy que LayerCove (Traefik / Nginx / Caddy) en HTTPS, puis mettez à jour l\'URL Spoolman dans les Paramètres avec la nouvelle adresse HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Le dépôt est PUBLIC. Les sauvegardes LayerCove contiennent les identifiants MQTT, les jetons Home Assistant, les jetons Prometheus, votre adresse Bambu Cloud, et les codes d\'accès des imprimantes via les K-profils. L\'enregistrement est bloqué tant que le dépôt n\'est pas passé en privé dans les paramètres de votre hébergeur.',
    repoVisibilityUnknown: 'Impossible de déterminer la visibilité du dépôt. LayerCove refuse toute sauvegarde vers un dépôt non confirmé privé ; l\'enregistrement sera bloqué.',
    ...
    appSettingsDescription: 'Configuration LayerCove (base de données complète)',
    ...
    localBackupDescription: 'Créez une sauvegarde complète de vos données LayerCove incluant la base de données, les archives, les téléchargements et tous les fichiers.',
    ...
    backupRestoredRestart: 'Sauvegarde restaurée. Veuillez redémarrer LayerCove.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Enregistré dans LayerCove, pas sur l\'imprimante',
  ...
  virtualPrinter: {
    ...
    howItWorks: {
      ...
      step2: 'En mode Archive, Revue et File d\'attente, utilisez le bouton "Envoyer" dans votre slicer pour envoyer des fichiers 3MF à LayerCove. Le slicer affichera "Impression réussie" — le fichier est stocké, pas imprimé.',
    ...
    caCert: {
      ...
      description: 'Les imprimantes virtuelles utilisent un certificat TLS signé par l\'autorité de certification LayerCove. Importez ce certificat CA dans le magasin de confiance de votre slicer une seule fois pour qu\'il accepte la connexion — plus besoin de le copier depuis la ligne de commande.',
      copy: 'Copier',
      copied: 'Copié',
      download: 'Télécharger',
      fingerprint: 'SHA-256',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL du backend LayerCove',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'LayerCove fonctionne en réseau Docker bridge. La découverte d\'imprimantes et l\'imprimante virtuelle nécessitent le mode réseau host — recréez le conteneur avec "network_mode: host".',
        skip: 'Ne fonctionne pas dans Docker — non applicable.',
      },
      subnet: {
        title: 'Sous-réseau',
        pass: 'L\'imprimante et LayerCove sont sur le même sous-réseau.',
        warn: 'L\'imprimante ({{printer_ip}}) et LayerCove ({{host_ip}}) sont sur des sous-réseaux différents. Ils peuvent ne pas se joindre, sauf si un routage entre les sous-réseaux est configuré.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Recopiez le code d\'accès depuis l\'écran de l\'imprimante (paramètres LAN) et mettez-le à jour dans les paramètres de l\'imprimante dans LayerCove.',
      },
      'ftp-connection-timeout': {
        name: 'Délai de connexion de transfert de fichiers dépassé',
        cause: 'LayerCove n\'a pas pu atteindre le port de transfert de fichiers de l\'imprimante (FTPS 990). Le port est bloqué, ou l\'imprimante est éteinte ou sur un autre sous-réseau.',
        fix: 'Assurez-vous que rien ne bloque le port 990 entre LayerCove et l\'imprimante, et que les deux sont sur le même réseau.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Faites passer LayerCove à une base de données PostgreSQL externe. Consultez le guide PostgreSQL dans la documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'L\'imprimante virtuelle est activée mais ses services ne sont pas en cours d\'exécution. Consultez le journal LayerCove — un conflit d\'IP de liaison ou une erreur de permission les arrête généralement.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificat prêt. Assurez-vous que le certificat CA LayerCove (ci-dessus) est importé dans le magasin de confiance de votre slicer.',
        fail: 'Le certificat TLS de cette imprimante virtuelle est manquant. Vérifiez que le répertoire de données LayerCove est accessible en écriture.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'L\'API ML récupère la capture caméra par URL. Définissez l\'URL externe dans les paramètres généraux pour que le conteneur API ML puisse atteindre LayerCove.',
  ...
  makerworld: {
    ...
    disclaimer: 'L\'intégration MakerWorld utilise des points de terminaison API documentés par la communauté. LayerCove n\'est ni affilié ni approuvé par MakerWorld ou Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Les fichiers dans les dossiers externes (liés) sont ignorés — LayerCove ne supprime jamais d\'octets qu\'il ne possède pas.',    previewLoading: 'Vérification du nombre de fichiers concernés…',
