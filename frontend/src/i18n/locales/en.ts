export default {
  ...
  nav: {
    ...
    installAppSuccess: 'LayerCove was installed',
  },
  ...
  printers: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'When on, this printer is paused from MQTT, queue dispatch and notifications — useful for repair, parallel LayerCove installs, or temporary suspension.',
    },
    // Chamber light
  ...
  archives: {
    ...
    no3mfBanner: {
      ...
      body: 'The slicer didn\'t leave the .gcode.3mf on the printer\'s SD card, so LayerCove couldn\'t pull the thumbnail or slicer metadata. This is usually because "Store sent files on external storage" is off in the slicer (Bambu Studio / OrcaSlicer Device tab).',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'LDAP groups are mapped to LayerCove groups on login',
      ...
      autoProvisionHint: 'Automatically create a LayerCove account on first LDAP login',
      ...
      groupMappingHint: 'Map LDAP group DNs to LayerCove groups. Available groups: ',
    ...
    preheatFilamentTargetsHint: 'LayerCove picks the highest target across the loaded AMS slots; PLA-only prints derive 0 and skip the chamber phase automatically.',
    ...
    authDisabledMessage: 'Enable authentication to create user accounts, manage permissions, and secure your LayerCove instance.',
    ...
    disableAuthenticationMessage: 'Are you sure you want to disable authentication? This will make your LayerCove instance accessible without login. All users will remain in the database but authentication will be disabled.',
    disableAuthentication: 'Disable Authentication',
    // Additional settings
    configureBambuddy: 'Configure LayerCove',
    ...
    updateViaHomeAssistant: 'Updates are managed by the Home Assistant Supervisor. Open Settings → Add-ons → LayerCove in Home Assistant to install the new version.',
    ...
    externalUrlDescription: 'The external URL where LayerCove is accessible. Used for notification images and external integrations.',
    ...
    mqttDescription: 'Publish LayerCove events to an external MQTT broker for integration with Node-RED, Home Assistant, and other automation systems.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'TOTP secrets and OIDC client_secrets are stored in plaintext. Set MFA_ENCRYPTION_KEY or restart LayerCove with a writable data directory to auto-generate one.',
      ...
      migrationErrorWarning: '{{count}} legacy row(s) failed to re-encrypt at startup. Check server logs and restart LayerCove to retry.',
    },
  ...
  login: {
    ...
    resetStep1: 'Contact your LayerCove administrator',
    ...
    twoFA: {
      ...
      instructionsTotp: 'Open your authenticator app and enter the 6-digit code for LayerCove.',
  ...
  // Setup page
  setup: {
    title: 'LayerCove Setup',
    subtitle: 'Configure authentication for your LayerCove instance',
  ...
  users: {
    ...
    subtitle: 'Manage users and their access to your LayerCove instance',
    backToSettings: 'Back to Settings',
    createUser: 'Create User',
    noPermission: 'You do not have permission to access this page.',
    admin: 'Admin',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Sign in to your Orca Cloud account to sync your slicer profiles into LayerCove.',
      },
      providers: {
  ...
  sponsors: {
    ...
    tagline: 'LayerCove is free and stays that way because people choose to support it. No VC, no cloud lock-in.',
    viewSupporters: 'View supporters',
    toastPrints: "You've completed {{count}} prints with LayerCove. LayerCove stays free thanks to its supporters.",
    toastCost: "You've tracked {{total}} in filament with LayerCove. See who keeps the project independent.",
    toastArchives: '{{count}} prints archived with LayerCove. See who keeps it independent.',
    toastAnniversary: 'One year with LayerCove! See who keeps the project independent.',
    toastVersionUpdate: 'Updated to v{{version}}. LayerCove stays free thanks to its supporters.',
  },
  ...
  inventory: {
    ...
    spoolmanMixedContentBody: 'LayerCove is served over HTTPS (via your reverse proxy), but your Spoolman URL is still plain HTTP. Browsers block mixed content for security, so the embedded Spoolman UI can\'t render. Spoolman needs to be reachable over HTTPS for this to work.',
    spoolmanMixedContentFixReverseProxy: 'Put Spoolman behind the same reverse proxy as LayerCove (Traefik / Nginx / Caddy) with HTTPS, then update the Spoolman URL in Settings to the new HTTPS address.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Repository is PUBLIC. LayerCove backups include MQTT credentials, Home Assistant tokens, Prometheus tokens, your Bambu Cloud email, and printer access codes via K-profiles. Saving is blocked until you make the repository private in your provider\'s settings.',
    repoVisibilityUnknown: 'Could not determine repository visibility. LayerCove refuses to back up to anything not confirmed private; saving will be blocked.',
    ...
    appSettingsDescription: 'LayerCove configuration (complete database)',
    ...
    localBackupDescription: 'Create a complete backup of your LayerCove data including the database, archives, uploads, and all files.',
    ...
    backupRestoredRestart: 'Backup restored. Please restart LayerCove.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Notes are saved in LayerCove, not on the printer',
  ...
  virtualPrinter: {
    ...
    remoteInterface: {
      ...
      hint: 'Override the IP address advertised via SSDP and used in the TLS certificate. Useful when LayerCove has multiple network interfaces.',
    },
    mode: {
      title: 'Mode',
      archive: 'Archive',
    ...
    howItWorks: {
      ...
      step2: 'In Archive, Review, and Queue modes, use the "Send" button in your slicer to upload 3MF files to LayerCove. The slicer will show "Print success" — the file is stored, not printed.',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'LayerCove is running in Docker bridge networking. Printer discovery and the Virtual Printer need host network mode — recreate the container with "network_mode: host".',
        skip: 'Not running in Docker — not applicable.',
      },
      subnet: {
        title: 'Network subnet',
        pass: 'The printer and LayerCove are on the same subnet.',
        warn: 'The printer ({{printer_ip}}) and LayerCove ({{host_ip}}) are on different subnets. They may not reach each other unless routing between the subnets is configured.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Re-copy the access code from the printer screen (LAN settings) and update it in the printer\'s settings in LayerCove.',
      },
      'ftp-connection-timeout': {
        name: 'File-transfer connection timed out',
        cause: 'LayerCove could not reach the printer\'s file-transfer port (FTPS 990). The port is blocked, or the printer is off or on another subnet.',
        fix: 'Make sure nothing blocks port 990 between LayerCove and the printer, and that both are on the same network.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Switch LayerCove to an external PostgreSQL database. See the PostgreSQL guide in the documentation.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'The virtual printer is enabled but its services are not running. Check the LayerCove log — a bind IP conflict or a permission error usually stops them.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        fail: 'The TLS certificate for this virtual printer is missing. Check that the LayerCove data directory is writable.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'The ML API fetches the camera snapshot by URL. Set the External URL in General settings so the ML API container can reach LayerCove.',
  ...
  makerworld: {
    ...
    disclaimer: 'MakerWorld integration uses community-documented API endpoints. LayerCove is not affiliated with or endorsed by MakerWorld or Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'Files in external (linked) folders are skipped — LayerCove never deletes bytes it does not own.',
