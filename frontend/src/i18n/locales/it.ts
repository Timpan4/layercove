export default {
  ...
  nav: {
    ...
    installAppSuccess: 'LayerCove è stato installato',
  },
  ...
  printers: {
    provider: 'Provider',
    moonrakerBaseUrl: 'URL base Moonraker',
    moonrakerWebsocketUrl: 'Override WebSocket (facoltativo)',
    moonrakerApiKey: 'Chiave API',
    moonrakerAuthorization: 'Autorizzazione',
    moonrakerTlsVerify: 'Verifica certificato TLS',
    moonrakerExternalCamera: 'Abilita videocamera esterna',
    moonrakerExternalCameraUrl: 'URL della videocamera esterna',
    moonrakerExternalCameraType: 'Tipo di videocamera esterna',
    moonrakerSecretRetained: 'Il segreto salvato viene mantenuto se lasciato vuoto',
    moonrakerTestConnection: 'Testa connessione salvata',
    moonrakerConnectionFailed: 'Impossibile connettersi a Moonraker.',
    emergencyStop: 'Arresto di emergenza',
    emergencyStopTitle: 'Arrestare la stampante in emergenza?',
    emergencyStopMessage: 'Arresta subito {{name}}. Riscaldatori e movimento possono fermarsi senza spegnimento normale.',
    emergencyStopConfirm: 'Arresto di emergenza',
    emergencyStopSent: 'Comando di arresto di emergenza inviato',
    emergencyStopFailed: 'Arresto di emergenza non riuscito',
    addPreflight: {
    ...
    maintenance: {
      ...
      editFieldHelp: 'Quando attivata, questa stampante è in pausa da MQTT, dispatch della coda e notifiche — utile per riparazioni, installazioni LayerCove parallele o sospensione temporanea.',
    },
    // Chamber light
    ...
    dropNotPrintableGcode: 'Su questa stampante è possibile stampare solo file .gcode',
    dropNotPrintable3mf: 'Su questa stampante è possibile stampare solo file .gcode.3mf',
  ...
  settings: {
    ...
    ldap: {
      ...
      feature3: 'I gruppi LDAP vengono mappati ai gruppi LayerCove al login',
      ...
      autoProvisionHint: 'Crea automaticamente un account LayerCove al primo accesso LDAP',
      ...
      groupMappingHint: 'Mappa i DN dei gruppi LDAP ai gruppi LayerCove. Gruppi disponibili: ',
    ...
    preheatFilamentTargetsHint: 'LayerCove sceglie il target più alto tra gli slot AMS caricati; le stampe solo PLA derivano 0 e saltano la fase camera automaticamente.',
    ...
    authDisabledMessage: 'Abilita autenticazione per creare account, gestire permessi e proteggere la tua istanza LayerCove.',
    ...
    disableAuthenticationMessage: 'Sei sicuro di voler disabilitare l\'autenticazione? Questo renderà la tua istanza LayerCove accessibile senza login. Tutti gli utenti resteranno nel database ma l\'autenticazione sarà disabilitata.',
    disableAuthentication: 'Disabilita autenticazione',
    // Additional settings
    configureBambuddy: 'Configura LayerCove',
    ...
    bambuddySoftware: 'Software LayerCove',
    ...
    updateViaHomeAssistant: 'Gli aggiornamenti sono gestiti dal Supervisor di Home Assistant. Apri Impostazioni → Add-on → LayerCove in Home Assistant per installare la nuova versione.',
    ...
    externalUrlDescription: 'L\'URL esterno dove LayerCove è accessibile. Usato per immagini di notifica e integrazioni esterne.',
    bambuddyUrl: 'URL LayerCove',
    ...
    mqttDescription: 'Pubblica eventi LayerCove su un broker MQTT esterno per l\'integrazione con Node-RED, Home Assistant e altri sistemi di automazione.',
    ...
    encryption: {
      ...
      notConfiguredDesc: 'I segreti TOTP e i client_secrets OIDC sono memorizzati in chiaro. Imposta MFA_ENCRYPTION_KEY o riavvia LayerCove con una directory dati scrivibile per generarne uno automaticamente.',
      ...
      migrationErrorWarning: "{{count}} riga/righe legacy non sono state ricifrate all'avvio. Controlla i log del server e riavvia LayerCove per riprovare.",
    },
  ...
  login: {
    ...
    resetStep1: 'Contatta il tuo amministratore LayerCove',
    ...
    twoFA: {
      ...
      instructionsTotp: "Apri la tua app di autenticazione e inserisci il codice a 6 cifre per LayerCove.",
  ...
  // Setup page
  setup: {
    title: 'Configurazione LayerCove',
    subtitle: 'Configura autenticazione per la tua istanza LayerCove',
  ...
  users: {
    ...
    subtitle: 'Gestisci utenti e accesso alla tua istanza LayerCove',
    backToSettings: 'Torna a Impostazioni',
    createUser: 'Crea utente',
    noPermission: 'Non hai il permesso di accedere a questa pagina.',
    admin: 'Amministratore',
  ...
  profiles: {
    ...
    orcaCloud: {
      ...
      connect: {
        ...
        description: 'Accedi al tuo account Orca Cloud per sincronizzare i profili dello slicer in LayerCove.',
      },
      providers: {
  ...
  sponsors: {
    ...
    tagline: 'LayerCove è gratuito e resta tale perché qualcuno sceglie di sostenerlo. Niente VC, niente lock-in cloud.',
    viewSupporters: 'Vedi i sostenitori',
    toastPrints: 'Hai completato {{count}} stampe con LayerCove. LayerCove resta gratuito grazie a chi lo sostiene.',
    toastCost: 'Hai monitorato {{total}} di filamento con LayerCove. Scopri chi mantiene il progetto indipendente.',
    toastArchives: '{{count}} stampe archiviate con LayerCove. Scopri chi lo mantiene indipendente.',
    toastAnniversary: 'Un anno con LayerCove! Scopri chi mantiene il progetto indipendente.',
    toastVersionUpdate: 'Aggiornato a v{{version}}. LayerCove resta gratuito grazie a chi lo sostiene.',
  },
  ...
  inventory: {
    ...
    spoolmanMixedContentFixReverseProxy: 'Metti Spoolman dietro lo stesso reverse proxy di LayerCove (Traefik / Nginx / Caddy) in HTTPS, poi aggiorna l\'URL di Spoolman nelle Impostazioni con il nuovo indirizzo HTTPS.',
  ...
  backup: {
    ...
    repoIsPublicWarning: 'Il repository è PUBBLICO. I backup di LayerCove includono credenziali MQTT, token di Home Assistant, token di Prometheus, la tua e-mail Bambu Cloud e i codici di accesso alle stampanti tramite K-profile. Il salvataggio è bloccato finché non rendi privato il repository nelle impostazioni del tuo provider.',
    repoVisibilityUnknown: 'Impossibile determinare la visibilità del repository. LayerCove rifiuta di eseguire backup su qualsiasi target non confermato come privato; il salvataggio sarà bloccato.',
    ...
    appSettingsDescription: 'Configurazione LayerCove (database completo)',
    ...
    localBackupDescription: 'Crea un backup completo dei tuoi dati LayerCove includendo database, archivi, upload e tutti i file.',
    ...
    backupRestoredRestart: 'Backup ripristinato. Riavvia LayerCove.',
  ...
  kProfiles: {
    ...
    modal: {
      ...
      notesHelp: 'Le note sono salvate in LayerCove, non sulla stampante',
  ...
  virtualPrinter: {
    ...
    enable: {
      ...
      visibleInSlicer: 'Visibile come "LayerCove" nella ricerca slicer',
    ...
    remoteInterface: {
      ...
      hint: 'Sovrascrive l\'indirizzo IP pubblicizzato via SSDP e usato nel certificato TLS. Utile quando LayerCove ha piu interfacce di rete.',
    },
    mode: {
      title: 'Modalita',
      archive: 'Archivio',
    ...
    howItWorks: {
      ...
      step2: 'In modalità Archivio, Revisione e Coda, usa il pulsante "Invia" nel tuo slicer per caricare file 3MF su LayerCove. Lo slicer mostrerà "Stampa riuscita" — il file viene salvato, non stampato.',
    ...
    caCert: {
      ...
      description: 'Le stampanti virtuali usano un certificato TLS firmato dalla CA di LayerCove. Importa questo certificato CA nell\'archivio attendibile del tuo slicer una sola volta affinché accetti la connessione — senza doverlo copiare dalla riga di comando.',
      copy: 'Copia',
      copied: 'Copiato',
      download: 'Scarica',
      fingerprint: 'SHA-256',
  ...
  spoolbuddy: {
    ...
    settings: {
      ...
      backendUrl: 'URL backend LayerCove',
      apiToken: 'Token API',
  ...
  diagnostic: {
    ...
    check: {
      ...
      network_mode: {
        ...
        warn: 'LayerCove è in esecuzione con la rete Docker bridge. Il rilevamento delle stampanti e la stampante virtuale richiedono la modalità di rete host — ricrea il container con "network_mode: host".',
        skip: 'Non in esecuzione in Docker — non applicabile.',
      },
      subnet: {
        title: 'Sottorete',
        pass: 'La stampante e LayerCove sono nella stessa sottorete.',
        warn: 'La stampante ({{printer_ip}}) e LayerCove ({{host_ip}}) sono in sottoreti diverse. Potrebbero non raggiungersi a meno che non sia configurato il routing tra le sottoreti.',
  ...
  systemHealth: {
    ...
    signature: {
      'ftp-auth-rejected': {
        ...
        fix: 'Ricopia il codice di accesso dallo schermo della stampante (impostazioni LAN) e aggiornalo nelle impostazioni della stampante in LayerCove.',
      },
      'ftp-connection-timeout': {
        name: 'Timeout della connessione di trasferimento file',
        cause: 'LayerCove non è riuscito a raggiungere la porta di trasferimento file della stampante (FTPS 990). La porta è bloccata, oppure la stampante è spenta o in un\'altra sottorete.',
        fix: 'Assicurati che nulla blocchi la porta 990 tra LayerCove e la stampante e che entrambi siano sulla stessa rete.',
      },
      'ftp-ssl-error': {
      ...
      'database-locked': {
        ...
        fix: 'Passa LayerCove a un database PostgreSQL esterno. Consulta la guida PostgreSQL nella documentazione.',
      },
    },
  },
  ...
  vpDiagnostic: {
    ...
    check: {
      ...
      running: {
        ...
        fail: 'La stampante virtuale è abilitata ma i suoi servizi non sono in esecuzione. Controlla il log di LayerCove — di solito li ferma un conflitto di IP di binding o un errore di permessi.',
      },
      bind_interface: {
      ...
      certificate: {
        ...
        pass: 'Certificato pronto. Assicurati che il certificato CA di LayerCove (sopra) sia importato nell\'archivio attendibile del tuo slicer.',
        fail: 'Il certificato TLS per questa stampante virtuale è mancante. Verifica che la directory dei dati di LayerCove sia scrivibile.',
      },
    },
  },
  ...
  failureDetection: {
    ...
    externalUrlHint: 'L\'API ML recupera l\'istantanea della telecamera tramite URL. Imposta l\'URL esterno nelle impostazioni generali in modo che il container API ML possa raggiungere LayerCove.',
  ...
  makerworld: {
    ...
    disclaimer: 'L\'integrazione MakerWorld utilizza endpoint API documentati dalla community. LayerCove non è affiliato né approvato da MakerWorld o Bambu Lab.',
  ...
  libraryPurge: {
    ...
    effect4: 'I file in cartelle esterne (collegate) vengono saltati — LayerCove non elimina mai dati che non possiede.',    previewLoading: 'Verifica quanti file corrispondono…',
