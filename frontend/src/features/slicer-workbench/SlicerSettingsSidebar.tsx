...
export function SlicerSettingsSidebar(props: SlicerSettingsSidebarProps) {
  ...
  // One vertical scroller keeps expanded catalogs, confirmation, and process settings reachable.
  return <aside className="flex h-full min-h-0 min-w-0 flex-col gap-2 overflow-x-hidden overflow-y-auto overscroll-contain bg-transparent p-2 text-white">
    {props.selectionPanel ? <section className="min-w-0 shrink-0 rounded-md border border-white/10 bg-[#292a2e] p-3 shadow-md shadow-black/15">{props.selectionPanel}</section> : <>
