...
export function SlicerCanvasWorkspace(props: SlicerCanvasWorkspaceProps) {
  const editable = Boolean(props.selectedObject && !props.selectedObject.locked);
