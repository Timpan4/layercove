<#
.SYNOPSIS
    LayerCove Docker installation script for Windows (Docker Desktop).
...
.PARAMETER InstallPath
    Installation directory. Default: $env:USERPROFILE\layercove
...
.EXAMPLE
    Unattended install:
      .\docker-install.ps1 -InstallPath C:\layercove -Port 8080 -TimeZone Europe/Berlin -Yes
#>
...
function Write-Banner {
    ...
    Write-Host '   LayerCove - Docker Installation (Windows)' -ForegroundColor Cyan
    Write-Host '==========================================================' -ForegroundColor Cyan
    Write-Host ''
}
...
function Get-ComposeFile {
    ...
    if ($Build) {
        ...
        Invoke-WebRequest `
            -Uri 'https://raw.githubusercontent.com/Timpan4/layercove/main/docker-compose.yml' `
...
function Start-LayerCove {
    Info 'Starting LayerCove container...'
    if ($Build) {
...
# Defaults
if (-not $InstallPath) { $InstallPath = Read-Default 'Installation directory' (Join-Path $env:USERPROFILE 'layercove') }
...
Write-Host '==========================================================' -ForegroundColor Green
Write-Host ''
Write-Host "  Access LayerCove:  http://localhost:$Port" -ForegroundColor Cyan
...
Write-Host ''
Write-Host '  Documentation:    https://github.com/Timpan4/layercove#readme' -ForegroundColor Cyan
Write-Host ''
